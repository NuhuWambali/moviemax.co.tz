                ...
                <div class="trailer-card" onclick="openTrailerModal('{{ addslashes($trailerMovie->trailer_url) }}')">
                    ...
                    <div class="trailer-info">
                        ...
                        <div class="meta">
                            ...
                            <span><i class="fas fa-star" style="color:#ff9800;"></i> {{ $trailerMovie->rating ?? 'N/A' }}</span>
                        </div>
                ...
                <div class="trailer-card" onclick="openTrailerModal('{{ addslashes($trailerSeriesItem->trailer_url) }}')">
                    ...
                    <div class="trailer-info">
                        ...
                        <div class="meta">
                            ...
                            <span><i class="fas fa-star" style="color:#ff9800;"></i> {{ $trailerSeriesItem->rating ?? 'N/A' }}</span>
                        </div>
