...
<div class="tab-content">
    ...
    <div class="tab-pane" id="tab-reactions">
        ...
        @endphp
        @if($myLikes->count() > 0)
            <h2 class="section-title" style="font-size:0.95rem;"><i class="fas fa-heart" style="color:#ff9800;"></i> Liked ({{ $myLikes->count() }})</h2>
        ...
        @if($myDislikes->count() > 0)
            <h2 class="section-title" style="font-size:0.95rem;"><i class="fas fa-heart-crack" style="color:#ffa94d;"></i> Disliked ({{ $myDislikes->count() }})</h2>
            <div class="item-grid">
