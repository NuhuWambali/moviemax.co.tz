...
<style>
    ...
    .search-type.movie { background: rgba(229, 9, 20, 0.2); color: #fbbf24; }
    .search-type.series { background: rgba(255, 215, 0, 0.2); color: #7db2ff; }
    .search-type.trailer { background: rgba(255, 215, 0, 0.2); color: #c084fc; }
    .search-empty {
        padding: 1rem;
        text-align: center;
