        ...
        <div class="auth-card">
            ...
            <a href="{{ route('google.redirect') }}" class="btn-google">
                <svg class="g-logo" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill="#34A853" d="M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.73-6c-2.15 1.45-4.92 2.3-8.16 2.3-6.26 0-11.57-4.22-13.47-9.91l-7.98 6.19C6.51 42.62 14.62 48 48 24 48z"/>
                </svg>
                Sign up with Google
            </a>
